...
(function (global, factory) {
  ...
  var Carousel = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto._slide = function _slide(direction, element) {
      ...
      var directionalclass = direction === DIRECTION_NEXT ? CLASS_NAME_START : CLASS_NAME_END;
      var orderclass = direction === DIRECTION_NEXT ? CLASS_NAME_NEXT : CLASS_NAME_PREV;
      ...
      if (this._element.classList.contains(CLASS_NAME_SLIDE)) {
        ...
        EventHandler.one(activeElement, 'transitionend', function () {
          ...
          activeElement.classList.remove(CLASS_NAME_ACTIVE$1, orderclass, directionalclass);
